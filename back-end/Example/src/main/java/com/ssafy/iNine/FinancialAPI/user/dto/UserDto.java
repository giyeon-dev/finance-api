package com.ssafy.iNine.FinancialAPI.user.dto;
...
public class UserDto {
    ...
    public static class Detail {
        ...
        public static Detail of(User user, List<AdditionalInfoDto> hobbyAdditional, List<AdditionalInfoDto> styleAdditional, List<AdditionalInfoDto> personalityAdditional) {
    ...
    public static class Info {
        ...
        public static Info of(User user, List<AdditionalInfoDto> hobbyAdditional, List<AdditionalInfoDto> styleAdditional, List<AdditionalInfoDto> personalityAdditional) {
            return Info.builder()
                    .nickname(user.getNickname())
                    .gender(user.getGender())
                    .region(user.getRegion())
